...
const deleteProp = (path) => (obj) => _.unset(obj, path);
const errorCodes = require('./error-codes');
const formioFetch = require('@formio/node-fetch-http-proxy');
...
global.btoa = (str) => {
    return str instanceof Buffer ? str.toString('base64') : Buffer.from(str.toString(), 'binary').toString('base64');
};
global.self = global;
